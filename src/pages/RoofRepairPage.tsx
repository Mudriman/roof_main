        ...
        <div className="max-w-2xl">
          <div className="space-y-6">
            ...
            <h1 className="text-5xl sm:text-6xl lg:text-7xl font-bold text-white leading-tight">
              Ремонт <span className="text-red-500">кровли</span>
            </h1>

            <p className="text-xl text-white/80 leading-relaxed max-w-xl">
              Оперативное устранение протечек и восстановление кровельного
              покрытия любой сложности. Работаем <span className="font-semibold text-white">24/7</span>.
            </p>

            {/* Преимущества списком */}
            <div className="space-y-3 mt-6">
              {['Выезд по согласованию', 'Гарантия на работы', 'Опыт 10+ лет'].map((item, index) => (
